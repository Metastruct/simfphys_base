...
local spritedamage = CreateClientConVar( "cl_simfphys_spritedamage", "1", true, false )
...
local function buildclientsettingsmenu( self )
	...
	createcheckbox(220,125,"Allow light damaging","cl_simfphys_spritedamage",self.PropPanel,0)
