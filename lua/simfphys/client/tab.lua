...
local function buildclientsettingsmenu( self )
	...
	createslider(30,110,345,20,"Hud offset X","cl_simfphys_hud_offset_x",self.PropPanel,-1,1,hud_x:GetFloat())
	createslider(30,130,345,20,"Hud offset Y","cl_simfphys_hud_offset_y",self.PropPanel,-1,1,hud_y:GetFloat())
	...
	Shape:SetColor( Color( 0, 0, 0, 200 ) )
	createcheckbox(25,170,"Hide Sprites","cl_simfphys_hidesprites",self.PropPanel,0)
	createcheckbox(210,170,"Allow light damaging","cl_simfphys_spritedamage",self.PropPanel,0)
	createcheckbox(25,190,"Front Projected Textures","cl_simfphys_frontlamps",self.PropPanel,0)
	createcheckbox(25,210,"Rear Projected Textures","cl_simfphys_rearlamps",self.PropPanel,0)
	createcheckbox(25,230,"Enable Shadows","cl_simfphys_shadows",self.PropPanel,0)
	...
	Shape:SetSize( 350, 85 )
	Shape:SetColor( Color( 0, 0, 0, 200 ) )
	createcheckbox(25,265,"Always Fullthrottle","cl_simfphys_sanic",self.PropPanel,sanic:GetInt())
	createcheckbox(25,285,"Engine Auto Start/Stop","cl_simfphys_autostart",self.PropPanel,autostart:GetInt())
	createcheckbox(25,305,"Automatic Transmission","cl_simfphys_auto",self.PropPanel,auto:GetInt())
	createcheckbox(25,325,"Automatic Sportmode (late up and downshifts)","cl_simfphys_sport",self.PropPanel,sport:GetInt())
	...
	local ctitem_1 = createcheckbox(25,360,"Enable Countersteer","cl_simfphys_ctenable",self.PropPanel,ctenable:GetInt())
	local ctitem_2 = createslider(30,380,345,40,"Countersteer Mul","cl_simfphys_ctmul",self.PropPanel,0.1,2,ctmul:GetFloat())
	local ctitem_3 = createslider(30,400,345,40,"Countersteer MaxAng","cl_simfphys_ctang",self.PropPanel,1,90,ctang:GetFloat())
	...
	local st_item_1 = createcheckbox(25,485,"Use these settings\n(you need to re-enter the vehicle)","cl_simfphys_overwrite",self.PropPanel,overwrite:GetInt())
	local st_item_2 = createslider(30,505,345,40,"steer speed","cl_simfphys_steerspeed",self.PropPanel,1,16,steerspeed:GetFloat())
	local st_item_3 = createslider(30,525,345,40,"fast speed steer angle","cl_simfphys_steerangfast",self.PropPanel,0,90,faststeerang:GetFloat())
	local st_item_4 = createslider(30,550,345,40,"fade speed(units/seconds)\nfor fast speed steer angle","cl_simfphys_fadespeed",self.PropPanel,1,5000,fadespeed:GetFloat())
	local st_item_5 = createcheckbox(25,590,"extra smooth steering","cl_simfphys_smoothsteer",self.PropPanel,smoothsteer:GetInt())
